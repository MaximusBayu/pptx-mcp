  ...
  if (templates.length === 0) {
    return (
      <div className="rounded-xl border border-dashed p-12 text-center text-gray-500">
        ...
        <a href="/templates/new" className="bg-black text-white px-4 py-2 rounded">Upload your first .pptx</a>
      </div>
    );
  }
    ...
    <motion.div variants={staggerContainer} initial="initial" animate="animate"
      ...
      {templates.map((t) => (
        <motion.div key={t.id} variants={cardItem}
          whileHover={{ y: -4 }} className="rounded-xl border p-5 shadow-sm flex flex-col">
